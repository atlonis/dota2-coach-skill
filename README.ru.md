...
Локализуются заголовки, таблица стадий, ограничения данных, STRATZ-уведомления и упражнение. Названия героев и предметов, API, JSON/schema keys, data gates и error codes остаются без перевода.
