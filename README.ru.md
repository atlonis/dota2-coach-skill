...
- Radiant/Dire draft, lane outcome, итоговые метрики, покупки начиная с предматчевого окна и инвентарь;
...
Дальнейшая работа выбирается по бенчмарку на реальных матчах: см. [ROADMAP.md](ROADMAP.md). Статистическая модель пика и глубокий `.dem`-анализ там заморожены, пока бенчмарк не покажет потребность. Личный прогресс по сохранённым нормализованным матчам уже доступен.
...
test/coaching/             синтетическая оценка ответа коуча
test/benchmark/            протокол бенчмарка на реальных матчах
research/coaching-videos/  выжимки из 50 обучающих видео и их сводка
docs/superpowers/          design spec и implementation plan
RESEARCH.md                исследование источников и решений
ROADMAP.md                 план развития по результатам бенчмарка
```
