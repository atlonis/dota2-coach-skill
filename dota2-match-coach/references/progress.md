...
- Cumulative last hits, denies, XP, and collected gold are compared at matching 10-, 15-, and 25-minute marks. Gold is the recorded OpenDota cumulative series, not net worth. A row requires the current measurement and at least two prior observed measurements; quote its own `matchCount`, not the total eligible history count.
