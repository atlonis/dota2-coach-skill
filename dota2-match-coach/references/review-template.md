...
3. **Сравнение:** self-baseline и релевантный внешний baseline.
4. **Внутри матча:** `лучший / смешанный / худший наблюдаемый отрезок` по доступным метрикам.
5. **Относительно ожидания:** `сильная / смешанная / слабая / недостаточно данных`; требуется baseline.
...
Числовой performance target требует baseline. Если его нет, упражнение измеряет процесс: например, после каждой смерти в найденном окне записать цель действия, доступную информацию, план выхода и фактический результат.
