...
Статус: исследование зафиксировано; на его основе собрана первая версия `dota2-above-context`.
...
- Dota2ProTracker исключён из runtime-цепочки. Ролевые эталоны, сильные игроки и свежие билды берутся через STRATZ; OpenDota используется как дополнительная проверка.
...
2. STRATZ — position 1–5, role/rank baselines, сильные игроки, playback и lane outcome.
